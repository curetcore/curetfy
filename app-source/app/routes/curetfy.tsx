      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-7xl py-24 sm:py-32 lg:py-40">
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            <div>
              <div className="mb-8">
                <div className="inline-flex rounded-full px-3 py-1 text-sm/6 text-gray-400 ring-1 ring-white/10 hover:ring-white/20">
                  App #1 de COD para Shopify en LATAM{" "}
                  <a href="#features" className="ml-2 font-semibold text-indigo-400">
              ...
              <div className="mt-10 flex items-center gap-x-6">
                <a
                  href="https://apps.shopify.com/curetfy-cod-form"
                  className="rounded-md bg-indigo-500 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-indigo-500/25 hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
                >
                  Comenzar Gratis
                </a>
            ...
            <div className="relative">
              <div className="rounded-2xl bg-linear-to-br from-indigo-600 to-purple-700 p-6 shadow-2xl shadow-indigo-500/30 sm:p-8">
                <div className="rounded-xl bg-white p-5 shadow-lg sm:p-6">
                  <div className="mb-4 text-center">
                    <p className="text-xs font-medium text-gray-500 uppercase tracking-wide">Vista previa del formulario</p>
                  </div>
                  <div className="space-y-4">
                    <div>
                      <label className="mb-1.5 block text-sm font-medium text-gray-700">Nombre completo</label>
                      <div className="h-10 rounded-lg bg-gray-100 ring-1 ring-gray-200"></div>
                    </div>
                    <div>
                      <label className="mb-1.5 block text-sm font-medium text-gray-700">Telefono WhatsApp</label>
                      <div className="h-10 rounded-lg bg-gray-100 ring-1 ring-gray-200"></div>
                    </div>
                    <div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div>
                        <label className="mb-1.5 block text-sm font-medium text-gray-700">Envio</label>
                        <div className="flex h-10 items-center rounded-lg bg-green-50 px-3 text-sm font-medium text-green-700 ring-1 ring-green-200">
                          $5.00
                        </div>
                      </div>
                    </div>
                    <button className="flex w-full items-center justify-center gap-2 rounded-xl bg-linear-to-r from-green-500 to-emerald-600 py-3.5 text-base font-semibold text-white shadow-lg shadow-green-500/25">
              ...
              {/* Decorative elements */}
              <div className="absolute -right-4 -top-4 size-24 rounded-full bg-indigo-500/20 blur-2xl"></div>
              <div className="absolute -bottom-4 -left-4 size-32 rounded-full bg-purple-500/20 blur-2xl"></div>
            </div>
          </div>
        </div>
        <div
